...
function shareFactionColors(faction) {
    if (faction === "德军")
        return { badgeFill: "#e1e1dd", badgeColor: "#46423b" };
    if (faction === "美军")
        return { badgeFill: "#d9e9dc", badgeColor: "#2c5a3e" };
    if (faction === "日军")
        return { badgeFill: "#f3d4ce", badgeColor: "#8a3128" };
    if (faction === "英军")
        return { badgeFill: "#d8ece7", badgeColor: "#23695f" };
    if (faction === "通用" || faction === "公用")
        return { badgeFill: "#ebe2bc", badgeColor: "#6f5413" };
...
function downloadCurrentShareImage() {
    if (!shareImageBlob || !shareImageUrl || !currentComparison)
        return;
